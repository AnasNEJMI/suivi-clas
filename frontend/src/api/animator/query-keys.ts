...
import type { QcmEvalQueryParams, SeanceQueryParams, LessonEvalQueryParams } from "./types"
...
export const animatorKeys = {
    ...
    skillEval : ({animatorId, studentId} : QcmEvalQueryParams) =>
    ['animator', 'skill-eval', animatorId, studentId] as const,
    qcms : ({animatorId, studentId} : QcmEvalQueryParams) =>
    ['animator', 'qcms', animatorId, studentId] as const,
}