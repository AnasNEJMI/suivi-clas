...
import AssocClassQCMsCarousel from './class-qcm-carousel';
import { Card, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
import { RotateCwFadingClockIcon } from 'lucide-react';

const AssocVisitStatsPerClass = ({qcmStatsPerScolarYear} : {qcmStatsPerScolarYear : QcmStatsPerScolarYear[]}) => {
  ...
  return (
    <>
      ...
      <div className='mt-2'>
        {
          qcmStats.classes.map((classQCMs, index) => (
            <AssocClassQCMsCarousel key={index} classQCMs = {classQCMs}/>
          ))
        }
      </div>
    </>
