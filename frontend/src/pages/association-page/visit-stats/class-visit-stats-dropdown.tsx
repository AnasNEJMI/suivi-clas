...
interface ClassVisitStatsDropdownProps {
    className? : string,
    classesStats : ClassVisitStats[],
    selectedValue : string,
    onValueChange : React.Dispatch<React.SetStateAction<ClassVisitStats>>
}

const ClassVisitStatsDropdown = ({className, classesStats, selectedValue, onValueChange} : ClassVisitStatsDropdownProps) => {
...
export default ClassVisitStatsDropdown