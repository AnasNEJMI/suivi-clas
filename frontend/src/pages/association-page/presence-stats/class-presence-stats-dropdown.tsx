...
const ClassPresenceStatsDropdown = ({className, classesStats, selectedValue, onValueChange} : ClassPresenceStatsDropdownProps) => {
...
export default ClassPresenceStatsDropdown