...
const LessonEvalsTab = () => {
  ...
  return (
    <>
        <TabHeader student={student} title = 'Éspace élève' subTitle='Évalution des leçons' description = "Retrouve ton niveau d'acquisition des leçons abordées lors des séances."/>
